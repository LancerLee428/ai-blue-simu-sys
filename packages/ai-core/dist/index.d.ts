...
export type ResourceGraphNodeType = 'force-unit' | 'platform' | 'weapon' | 'sensor' | 'geo-zone' | 'mission';
...
export type ResourceRelationshipType = 'belongs_to' | 'can_command' | 'can_communicate' | 'can_detect' | 'can_strike' | 'can_support' | 'deployable_to' | 'suitable_for';
...
export type SelectedResourceRole = 'command' | 'reconnaissance' | 'electronic-warfare' | 'strike' | 'communication-relay' | 'support';
